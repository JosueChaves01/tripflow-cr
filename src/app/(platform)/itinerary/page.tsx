...
import { PreferencesForm } from '@/features/itinerary/components/PreferencesForm'
    ...
    <div className="min-h-screen bg-slate-50 px-4 py-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div>
            <h2 className="mb-4 text-xl font-semibold text-slate-800">{t('travelPreferences')}</h2>
            <PreferencesForm />
          </div>
          <div>
